...
public final class LangfordsGenerator {
    ...
    public static void main(String[] args) {
        if (args.length != 2) {
            System.out.println("Usage: java generators.LangfordsGenerator <k> <n>");
        ...
        for (int i = 0; i < seqLength; i++) {
            System.out.println("1, " + seqLength);
        }
